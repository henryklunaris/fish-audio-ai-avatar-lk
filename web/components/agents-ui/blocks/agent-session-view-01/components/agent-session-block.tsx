...
import { MoodBadge } from '@/components/app/mood-badge';
...
export function AgentSessionView_01({
  ...
  return (
    ...
    >
      ...
      >
        {/* Current emotion from Fish Audio expressive mode */}
        <div className="pointer-events-none mx-auto flex w-full max-w-2xl justify-center pb-3">
          <MoodBadge />
        </div>
        {/* Pre-connect message */}
